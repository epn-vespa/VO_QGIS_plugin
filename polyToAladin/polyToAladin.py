...
from polyToAladin_dialog import polyToAladinDialog
import os.path
...
class polyToAladin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'polyToAladin_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&polyToAladin')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'polyToAladin')
        self.toolbar.setObjectName(u'polyToAladin')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('polyToAladin', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/polyToAladin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'polyToAladin'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            self.sendSRegionToAladin(self.iface)
        self.cli.disconnect()

    def sendSRegionToAladin(self, miface):
        iface=miface
